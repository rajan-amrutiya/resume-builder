...
const resumeController = new ResumeController(getUserResumesUseCase, getResumeByIdUseCase, createResumeUseCase);
...
router.get(
  '/:id',
  AuthMiddleware.authenticate,
  (req, res) => resumeController.getResumeById(req, res)
);
