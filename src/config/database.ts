...
export const AppDataSource = new DataSource({
  ...
  host:
    process.env.DB_HOST ||
    "SG-Resume-Builder-12570-mysql-master.servers.mongodirector.com",
  ...
  entities: [
    path.join(
      __dirname,
      "../modules/resumes/infrastructure/entities/*.{ts,js}"
    ),
    path.join(__dirname, "../modules/users/infrastructure/entities/*.{ts,js}"),
  ],
